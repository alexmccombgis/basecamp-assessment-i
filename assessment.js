...
if(notHakeem!=myName){notHakeem = true}
...
// #8 Create an if statement inside of the responseCreator function that sets the colorResponse variable value based off of 
//a passed in value. The param value passed in will be added in the unit test. If the param value is 'green' set colorResponse 
...
function sum(num){return num + num};
